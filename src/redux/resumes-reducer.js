    ...
    switch(action.type) {
        case ADD_RESUME: {
            let newRes = {
                ...
                date: "03.11.2022",
                name: "Вася Пупкин",
                post: state.newResPost,
                salary: state.newResSalery,
                exp: state.newResExp,
                about: state.newResAbout
            };
            return {
                ...state,
